...
class GMNlayer(MessagePassing):
    ...
    def forward(self, x1,x2, edge_index1,edge_index2,edge_weight1,edge_weight2,mode='train'):
        ...
        m1=self.propagate(edge_index,size=(x1.size(0), x1.size(0)), x=x1,edge_weight=edge_weight1)
        edge_index = edge_index2
        m2=self.propagate(edge_index,size=(x2.size(0), x2.size(0)), x=x2,edge_weight=edge_weight2)
